...
Instead of every steam system looking perfectly sealed and static, steam setups can now hiss, vent, leak lightly, and give off small pressure-based vapour effects.

Build cleaner. Feel more industry. Keep your steam builds looking active, mechanical, and believable.

---

## 🎬 Demo Video

![Real Steam Demo](https://github.com/SquishyPoos1870/-Real-Steam/blob/main/Factorio%202026.06.13%20-%2018.35.53.02.mp4?raw=true)

If the video does not show in your browser, open it here:

[▶️ Watch Real Steam Demo on GitHub](https://github.com/SquishyPoos1870/-Real-Steam/blob/main/Factorio%202026.06.13%20-%2018.35.53.02.mp4)
...
Boilers, heat exchangers, steam engines, and steam turbines can emit additional steam effects while working. Steam pipes can also show small leaks, hiss points, and venting around heavier pressure areas like pipe-to-ground joins.

The goal is not to turn your base into a giant white cloud. The goal is to make steam systems feel more mechanical, active, and believable while still fitting the normal Factorio style.

Higher-quality equipment can now also look cleaner. When the quality feature is enabled, better-quality steam equipment produces fewer visible leaks, making upgraded machines feel better built and better maintained.
...
* **Real Smoke** can run alongside Real Steam for a fuller industrial look

Real Steam still works perfectly fine on its own if those mods are not installed.
...
* 🌧️ Optional integration with Real Rain
...
Real Steam is designed to work well by itself, but it can also optionally interact with other mods in the Real series.
...
* **Real Rain**
  Rain and storms can make steam systems feel more atmospheric.

* **Real Wind**
  Wind and storm gusts can pull steam wisps sideways for a more natural look.

* **Real Smoke**
  Pairs well visually with Real Smoke for a fuller industrial factory atmosphere.
